...
<!-- 검색폼 -->
<div class="search">
	<form class="d-flex position-absolute top-50 start-50 translate-middle" role="search" action="${pageContext.request.contextPath}/actPage/actList.jsp" method="GET" onsubmit="return searchForm();">
