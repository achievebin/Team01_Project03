...
%>
        <tr align="center">
            ...
            <td align="left">  <!--제목(+ 하이퍼링크)-->
                <a href="View.jsp?num=<%= dto.getActNumber() %>"><%= dto.getActName() %></a>
            </td>
            <td align="center"><%= dto.getActName() %></td>          <!--작성자 아이디-->
            <td align="center"><%= dto.getActPhone() %></td>  <!--조회수-->
            <td align="center"><%= dto.getActRoom() %></td>    <!--작성일-->
        </tr>
<%
    }
}
